...
private_cloud.controller("cloudComputerController", [ "$scope", "$sce", "$rootScope", "$http", "all_check_service", "$q", "$timeout", "$window", "$interval", "$location", function(e, t, o, n, a, s, i, l, r, d) {
    e.url = d.path(), e.vm_state = {
        initialized: "创建",
        active: "运行",
        rescued: "灾备运行",
        paused: "暂停",
        ...
        n({
            ...
            console.log(a), angular.forEach(a, function(t, a) {
                ...
                }, function(e) {}), e.cloudHost.push(s), e.$on("ngRepeatFinished", function(e) {
                    $("#config" + a).popover({
                        html: !0,
    ...
    }), e.deleteCloud = function(e, t) {
        confirm("您确定删除" + t + "吗？此操作不可恢复！") && n({
            url: "/api/list_servers/" + e,
            method: "DELETE",
            headers: o.headers
        }).then(function(e) {
            204 == e.status && (alert("操作成功"), l.location.reload());
        }, function() {
            alert("操作失败请重试");
        });
        ...
        var a = {};
        a["os-" + t] = null, angular.forEach(e.cloudHost, function(e, t) {
            e.check_status && (console.log(e.id), n({
                url: "/api/server_action/" + e.id,
                method: "POST",
                headers: o.headers,
                data: a
            }).then(function() {}, function() {}));
        }), angular.isDefined(o.interval) && (r.cancel(o.interval), o.interval = null), 
        o.interval = r(function() {
            "/count/computer" == e.url && n({
                url: "/api/list_servers/detail",
                method: "GET",
                headers: o.headers
            }).then(function(t) {
                var o = t.data.servers;
                angular.forEach(o, function(t, o) {
                    console.log(e.cloudHost[o]), e.cloudHost[o].vmState = e.vm_state[t["OS-EXT-STS:vm_state"]], 
                    e.cloudHost[o].taskState = e.task_state[t["OS-EXT-STS:task_state"]], e.cloudHost[o].powerState = e.power_state[t["OS-EXT-STS:power_state"]];
                });
            }, function() {}), e.url = d.path();
        }, 5e3);
    };
} ]);
