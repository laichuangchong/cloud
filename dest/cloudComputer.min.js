...
private_cloud.controller("cloudComputerController", [ "$scope", "$sce", "$rootScope", "$http", "all_check_service", "$q", "$timeout", "$window", "$interval", "$location", function(e, t, o, n, a, s, l, r, i, c) {
    function d(t, o) {
        t.vm = {
    ...
    e.url = c.path(), e.warn = !1, e.warnText = [], e.vm_state = {
        ...
        n({
            ...
            console.log(a), angular.forEach(a, function(t, a) {
                ...
                var l = t.image.id;
                d(s, t), s.diskConfig = t["OS-DCF:diskConfig"], console.log(s), angular.forEach(o.images, function(e, t) {
                    l == e.id && (s.imageName = e.name);
                }), n({
                ...
                }, function(e) {}), e.cloudHost.push(s), null != t["OS-EXT-STS:task_state"] && (e["intervalInit" + a] = i(function() {
                    n({
        ...
        n({
            ...
            console.log(s), 202 == s.status && (e["restartComputer" + a] = i(function() {
                n({
                    url: "/api/list_servers/" + t,
                    method: "GET",
                    headers: o.headers
        ...
        console.log(e.selectImage), n({
            ...
            console.log(e), 202 == e.status && r.location.reload();
        }, function(e) {
            alert(e.statusText);
        });
        ...
        a["os-" + t] = null, angular.forEach(e.cloudHost, function(t, s) {
            t.check_status && (console.log(t.id), n({
                ...
                console.log(a), e["intervalToggle" + s] = i(function() {
                    n({
                        ...
                        e.cloudHost[s].powerState = e.power_state[o["OS-EXT-STS:power_state"]], null == o["OS-EXT-STS:task_state"] && (i.cancel(e["intervalToggle" + s]), 
    ...
    }, e.toggleComputer = function(t, a, s) {
        var l = {};
        l["os-" + t] = null, n({
            ...
            console.log(t), e.warn = !0, e.warnText.push("错误" + t.status + " 云主机：" + value.name + "操作失败");
        });
    };
} ]);
